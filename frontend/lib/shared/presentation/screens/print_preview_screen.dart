      ...
      body: _loading
          ...
          : _error != null
              ...
              : _record == null
                  ...
                  // Render the ACTUAL generated PDF for the preview so pagination,
                  // sidebar, footer, fonts, and layout are always 100% identical to
                  // what gets printed/exported - including page count. If the
                  // preview shows 2 pages, the export/print will always show 2
                  // pages too, since they are literally the same PDF bytes.
                  : PdfPreview(
